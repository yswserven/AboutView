...
public class WaveView extends View {
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (arrt) {
                ...
                case R.styleable.WaveView_wavepercent:
                    waveViewPercent = array.getFloat(arrt, waveViewPercent);
                    break;
    ...
    private void DrawCicleStorke(Canvas canvas, int Width, int Height) {
        ...
        mPaint.setAntiAlias(true);
        RectF rectF = new RectF((float) (waveViewStrokeWidth / 2), (float) (waveViewStrokeWidth / 2),
                (float) (Width - waveViewStrokeWidth / 2), (float) (Height - waveViewStrokeWidth / 2));
