...
public class PieChartView extends View {
    ...
    private int mPieColors[] = {Color.parseColor("#8BE9EB"), Color.parseColor("#FFEC69"),
            Color.parseColor("#868394"), Color.parseColor("#FF574A")};
    ...
    public PieChartView(Context context) {
        super(context);
        mTotalMoney = mData[0] + mData[1] + mData[2] + mData[3];
    }
    ...
    private void DrawArc(Canvas canvas) {
        ...
        for (int i = 0; i < mPieColors.length; i++) {
            ...
            float percent = mData[i] / mTotalMoney;
